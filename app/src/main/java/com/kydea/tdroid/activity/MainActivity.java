package com.kydea.tdroid.activity;
...
import com.kydea.tdroid.adapter.FragmentTabAdapter;
import com.kydea.tdroid.comm.BluetoothCommService;
import com.kydea.tdroid.comm.OutputPacket;
import com.kydea.tdroid.fragment.FragmentOneKey;
import com.kydea.tdroid.fragment.FragmentDebug;
...
//		menu.add(this.MENU_ENCRYPT);
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		if(menuString.equals(this.MENU_BACKWARD))
			bluetoothCommService.addPacket(new OutputPacket("vr=-40,0"));
		else if(menuString.equals(this.MENU_ENCODER))
			bluetoothCommService.addPacket(new OutputPacket("encoder=?"));
...
//			bluetoothCommService.addPacket(new OutputPacket("encrypt=?"));
			...
			bluetoothCommService.addPacket(new OutputPacket("heading=?"));
		else if(menuString.equals(this.MENU_IMUCAL))
			bluetoothCommService.addPacket(new OutputPacket("imucal"));
		else if(menuString.equals(this.MENU_PWM))
			bluetoothCommService.addPacket(new OutputPacket("pwm=?"));
		else if(menuString.equals(this.MENU_ROTATE))
			bluetoothCommService.addPacket(new OutputPacket("vr=40,1"));
		else if(menuString.equals(this.MENU_BATTERY))
			bluetoothCommService.addPacket(new OutputPacket("battery=?"));
		return true;
	}
