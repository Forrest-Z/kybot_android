...
public abstract class BaseActivity extends FragmentActivity {
	...
	public static String rootpath =null;//= Environment.getExternalStorageDirectory().getAbsolutePath()+"/配置软件";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(Environment.getExternalStorageDirectory() != null)
			rootpath = Environment.getExternalStorageDirectory().getAbsolutePath()+"/Tdroid";
	}
